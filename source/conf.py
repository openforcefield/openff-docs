...
intersphinx_mapping = {
    ...
    "openff.bespokefit": ("https://docs.openforcefield.org/projects/bespokefit/en/stable", None),
    "openff.qcsubmit": ("https://docs.openforcefield.org/projects/qcsubmit/en/latest", None),
    "openff.fragmenter": ("https://docs.openforcefield.org/projects/fragmenter/en/stable", None),
    "openff.evaluator": ("https://docs.openforcefield.org/projects/evaluator/en/stable", None),
    "openff.recharge": ("https://docs.openforcefield.org/projects/recharge/en/stable", None),
    "openff.nagl": ("https://docs.openforcefield.org/projects/nagl/en/stable", None),
    "openff.nagl_models": ("https://docs.openforcefield.org/projects/nagl-models/en/stable", None),
}
